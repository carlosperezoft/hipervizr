   ...
   navbarPage(tags$b("Descriptivo-2D"),
     ...
     navbarMenu("Correlaci\u00F3n",
        ...
        tabPanel("Diagrama de Cuerdas", icon = icon("life-ring"),
          ...
          bsPopover(id="cuerdasCorrPlotOut", title="Diagrama de Cuerdas", placement = "top", trigger = "hover",
        ...
        tabPanel("Matriz de Dispersi\u00F3n",icon = icon("th"), h4("Matriz de Dispersi\u00F3n (Scatter Plot Matrix - SPLOM)"),
          bsPopover(id="splomCorrPlotOut", title="Matriz de Dispersi\u00F3n (SPLOM)", placement = "top", trigger = "hover",
